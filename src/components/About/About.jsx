...
const About = () => {
  ...
  return (
        ...
        <h2>
          {
            <div className="max-w-[1600px] m-auto md:h-[300px] h-[100px] flex items-center">
              <h2 className="md:text-4xl md:px-0 px-5 text-2xl dark:text-white text-[#235275]">
                {t("home")} / {t("aboutUs")}
              </h2>
            </div>
          }
      ...
      <section className="md:max-w-[1000px] w-[90%] m-auto text-center my-20">
        <span className="md:text-5xl text-2xl font-bold dark:text-white"><span className="text-[#BA5D2C]">/</span> {t("aboutUs")}</span>
        <p className="md:text-2xl my-9 pb-24 dark:text-gray-400">{t("aboutTxt")}</p>
      </section>
    </div>
  )
}
